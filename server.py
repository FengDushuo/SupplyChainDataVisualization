...
from handlers.inputdata import InputdataipsHandler,InputdatatimestampHandler,Inputdataips1Handler,Inputdataips2Handler,Inputdataips3Handler,Inputdataips4Handler
from handlers.inputdata_operate import UploadFileHandler
from handlers.inputdata_show import Inputdatashow_ipsHandler,Inputdatashow_timestampHandler,Inputdatashow_timestamp_onelabelHandler,Inputdatashow_timestamp_twolabelHandler,Inputdatashow_ips1Handler,Inputdatashow_ips2Handler,Inputdatashow_ips3Handler
...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r"/inputdata_ips1",Inputdataips1Handler),
            (r"/inputdata_ips2",Inputdataips2Handler),
            (r"/inputdata_ips3",Inputdataips3Handler),
            (r"/inputdata_ips4",Inputdataips4Handler),
            (r"/upload_file",UploadFileHandler),
            (r"/inputdatashow_ips",Inputdatashow_ipsHandler),
            (r"/inputdatashow_ips1",Inputdatashow_ips1Handler),
            (r"/inputdatashow_ips2",Inputdatashow_ips2Handler),
            (r"/inputdatashow_ips3",Inputdatashow_ips3Handler),
