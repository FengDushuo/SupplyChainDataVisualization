...
var count_file = '/static/data/count.json';
var city = file.split("/")[3].split(".")[0];
var city1 = '宁波';
var type = '空气炸锅';
var type1 = '空气炸锅';
var flag=0;
...
var timeOut = null;
  ...
  function single (e) {
      ...
      timeOut = setTimeout(function () {
          ...
          .delay(function (d, i) {return arcAnimDur + i * secIndividualdelay;}).
          duration(secDur);
          file = '/static/data/'+e.data.name+'.json'; 
          city = e.data.name;
          var names1 = []; //类别数组（用于存放饼图的类别）
          var brower1 = [];
          $.ajax({
            url: "/static/data/count.json",
            data: {},
            type: 'GET',
  ...
  function double (e) {
      ...
      .delay(function (d, i) {return arcAnimDur + i * secIndividualdelay;})
      .duration(secDur);
      var file1 = '/static/data/'+e.data.name+'.json'; 
      city1 = e.data.name
      var names1 = []; //类别数组（用于存放饼图的类别）
      var brower1 = [];
      $.ajax({
