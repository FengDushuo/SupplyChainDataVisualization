...
var count_file = '/static/data/count1.json';
var city = file.split("/")[3].split(".")[0]+'1';
console.log(city);
var city1 = '宁波1';
var type = '空气炸锅';
var type1 = '空气炸锅';
...
function single (e) {
    ...
    timeOut = setTimeout(function () {
        ...
        .delay(function (d, i) {return arcAnimDur + i * secIndividualdelay;}).
        duration(secDur);
        file = '/static/data/'+e.data.name+'1.json'; 
        city = e.data.name+'1';
          var names1 = []; //类别数组（用于存放饼图的类别）
          var brower1 = [];
          $.ajax({
            url: "/static/data/count1.json",
            data: {},
            type: 'GET',
...
function double (e) {
  ...
  //     traget.style.display="block";
    ...
    .delay(function (d, i) {return arcAnimDur + i * secIndividualdelay;})
    .duration(secDur);
    var file1 = '/static/data/'+e.data.name+'1.json'; 
    city1 = e.data.name+'1'
    var names1 = []; //类别数组（用于存放饼图的类别）
    var brower1 = [];
    $.ajax({
