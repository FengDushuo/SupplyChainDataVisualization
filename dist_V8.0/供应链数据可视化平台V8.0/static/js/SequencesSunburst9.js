var file = '/static/data/上海新国际3.json';
  ...
  function generateChart(data) {
      ...
      const circle = node.append('circle')
          ...
          .on('mouseover', function (e, d) {
              ...
              tooltip.select('#ground').text(''+ (d.data.ground == ""?"无":d.data.ground)).attr("font-family", "Microsoft Yahei");
              tooltip.select('#property').text(''+ (d.data.property == ""?"无":d.data.property)).attr("font-family", "Microsoft Yahei");
              tooltip.select('#address').text('地址：'+ (d.data.address == ""?"无":d.data.address)).attr("font-family", "Microsoft Yahei");
...
var colors = ["#66CCCC","#FF99CC","#FF9999","#99CC66","#5151A2","#FF9900","#FF6600","#CCFF66"];
  ...
  var draw = function draw() {
    var  emblemText= ['上  海  国  家  会  展  中  心', '南  京  国  际  博  览  中  心', '宁  波  国  际  会  展  中  心', '上  海  新  国  际  博  览  中  心'];   
    circleText('.emblem');
